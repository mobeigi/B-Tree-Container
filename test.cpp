...
int main() {
  ...
  * Testing: Valid insertion, Size 1 BTree, Iteration over this tree, Test output of BTree using operator<<, duplicates, finding, copy constructors, move constructors, iterator const correctness
  *
  */
  {
    try {
      ...
      */
      ...
      assert(ret1.second == ret2.second == ret3.second == ret4.second == true);
      ...
      assert(ret5.second == ret6.second == ret7.second == ret8.second == ret9.second == false);
